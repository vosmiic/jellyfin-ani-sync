...
namespace jellyfin_ani_sync.Models.Kitsu {
    ...
    public class KitsuSearch {
        public class Titles {
            ...
            [JsonPropertyName("ja_jp")] public string Japanese { get; set; }
        }
        ...
        public class MediaRelationships {
            ...
            [JsonPropertyName("data")] public List<KitsuAnime> Data { get; set; }
        }
        ...
        public class KitsuSearchMedia {
            [JsonPropertyName("data")] public List<KitsuAnime> KitsuSearchData { get; set; }
