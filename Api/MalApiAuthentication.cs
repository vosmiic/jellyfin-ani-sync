...
namespace jellyfin_ani_sync.Api {
    public class MalApiAuthentication {
        ...
        public MalApiAuthentication(IHttpClientFactory httpClientFactory) {
        ...
        public ApiAuth GetMalToken(string? code = null, string? refreshToken = null) {
            ...
            ApiAuth? apiAuth = Plugin.Instance.PluginConfiguration.ApiAuth != null ? Plugin.Instance.PluginConfiguration.ApiAuth.FirstOrDefault(item => item.Name == ApiName.Mal) : null;
            ...
            if (apiAuth != null) {
                ...
                Plugin.Instance.PluginConfiguration.AddApiAuth(newApiAuth);
            }
